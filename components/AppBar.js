import { Anchor, Box, Button, Collapsible, Grommet, Heading, Nav, ResponsiveContext, Text } from "grommet";
...
const AppBar = (props) => {
  ...
  >
    ...
    return (<Grommet theme={global.theme}>
  <Nav
    tag="header"
    flex={{ shrink: false }}
    direction="row"
  ...
  >
      ...
      <Anchor alignSelf="center" icon={<Menu />} onClick={()=> {setSidebarVisible(!sidebarVisible)}} />
      <Heading
        color="brand"
        level="2"
        margin="medium"
  ...
  >
    <Anchor
      ...
      <Anchor margin={{
        top: "none",
        bottom: "xsmall",
      }} label="Creations" href="creations" color="dark-1" size="medium" />
      <Anchor margin={{
        top: "none",
        bottom: "xsmall",
      }} label="Media" href="media" color="dark-1" size="medium" />
      <Anchor margin={{
        top: "none",
        bottom: "xsmall",
      }} label="Awards" href="awards" color="dark-1" size="medium" />
