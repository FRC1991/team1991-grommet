      ...
      <Card margin="small" background="light-1" elevation="large">
        ...
        <CardBody direction="row" pad="medium">
          ...
          <Box width="50%" direction="column" overflow="auto">
            ...
            >
              Team 1991, The Dragons, is a student run high school team which
              was founded in 2007 by a group of students, teachers and mentors
              who wanted to represent their school's engineering focus in a
            ...
            >
              Participation in the team gives students an opportunity to learn
              about engineering and technology through hands on experience.
              Since the team operates like a business, students acquire many
              professional skills, such as managing a budget, making
              presentations and planning our build season. As an extracurricular
            ...
            >
              ...
              challenges engineers face when working on the projects.
            </Paragraph>
            <Paragraph
              fill
              margin={{
      ...
      <Card margin="small" background="light-1" elevation="large">
        ...
        <CardBody direction="column" pad="medium">
          ...
          >
            ...
            We were founded in 2007 by a group of students, teachers and mentors
            who wanted to represent their school's engineering focus in a
            competitive environment.
          </Paragraph>
          <Paragraph
          ...
          >
            Participating in the team gives students an opportunity to learn
            about engineering and technology through hands-on experience. Since
            the team operates like a business, students acquire many
            professional skills, such as managing a budget, making presentations
            and planning our build season. As an extracurricular program, the
            team allows students to apply concepts learned in school as well as
            develop new skills thanks to various workshops taught by our mentors
            and expereinced students. Over the years, our students were able to
            take advantage of the SolidWorks, LabView, Java/WPILib, Welding and
            Electronics classes.
          </Paragraph>
          <Paragraph
            fill
          ...
          >
            Each year, the team participates in the FIRST Robotics Competition
            which FIRST. calls as the "Varsity Sport for the Mind™". The teams
            are given only six weeks to design, construct and program a robot
            which will compete against other teams in regional and national
            events. This closely mimics the real life challenges engineers face
